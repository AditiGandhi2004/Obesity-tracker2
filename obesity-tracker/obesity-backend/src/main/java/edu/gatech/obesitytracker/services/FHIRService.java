...
import edu.gatech.obesitytracker.entities.HealthEntryType;
...
import edu.gatech.obesitytracker.fhir.FHIRHelper;

@Component
public class FHIRService implements IFHIRService {

    private static final String ObesityTrackerSystemIdentifier = "obesity-tracker-app";
    ...
    private Patient getPatient(User user) throws Exception {
        Bundle bundle = client.search()
                ...
                .where(Patient.IDENTIFIER.exactly().systemAndIdentifier(ObesityTrackerSystemIdentifier, user.getPatientId()))
    ...
    private Observation buildObservation(Patient patient, HealthEntryDto healthEntryDto) throws Exception {
        ...
        observation
                ...
                .setSubject(new Reference().setReference("Patient/1"));
    ...
    private Patient buildPatient(User user) {
        ...
        patient.addIdentifier()
                .setSystem(ObesityTrackerSystemIdentifier)
